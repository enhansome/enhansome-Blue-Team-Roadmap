...
* Install with [SwiftOnSecurity's Sysmon config](https://github.com/SwiftOnSecurity/sysmon-config) ⭐ 5,639 | 🐛 82 | 📅 2024-07-03 for a well-tuned baseline
* Alternative: [Olaf Hartong's Sysmon Modular config](https://github.com/olafhartong/sysmon-modular) ⭐ 3,130 | 🐛 49 | 🌐 PowerShell | 📅 2026-08-31
...
| Tool                       | Purpose                                         | Link                                                                                                                                   |
| -------------------------- | ----------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| **Volatility 3**           | Memory forensics (RAM analysis)                 | [github.com/volatilityfoundation](https://github.com/volatilityfoundation/volatility3) ⭐ 4,377 \| 🐛 136 \| 🌐 Python \| 📅 2026-08-19 |
...
| **Velociraptor**           | Endpoint investigation at scale                 | [github.com/Velocidex](https://github.com/Velocidex/velociraptor) ⭐ 4,238 \| 🐛 75 \| 🌐 Go \| 📅 2026-09-05                           |
...
| ------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| **SIGMA Rules**     | Vendor-agnostic detection rules (3,000+) | [github.com/SigmaHQ](https://github.com/SigmaHQ/sigma) ⭐ 10,996 \| 🐛 197 \| 🌐 Python \| 📅 2026-09-07     |
| **YARA Rules**      | Malware pattern matching                 | [github.com/VirusTotal/yara](https://github.com/VirusTotal/yara) ⭐ 9,853 \| 🐛 169 \| 🌐 C \| 📅 2026-08-25 |
...
| **Shuffle**                       | Open-source SOAR                | [github.com/Shuffle](https://github.com/Shuffle/Shuffle) ⭐ 2,427 \| 🐛 491 \| 🌐 JavaScript \| 📅 2026-09-07 |
...
2. **Adversary Emulation with Atomic Red Team**
   * Install [Atomic Red Team](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,498 | 🐛 31 | 🌐 C | 📅 2026-09-05 on a test machine
...
6. **Open-Source Detection Rule Contributions**
   * Contribute to [SigmaHQ/sigma](https://github.com/SigmaHQ/sigma) ⭐ 10,996 | 🐛 197 | 🌐 Python | 📅 2026-09-07
...
| -------------------------------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| SigmaHQ/sigma                          | 3,000+ vendor-agnostic detection rules      | [github.com](https://github.com/SigmaHQ/sigma) ⭐ 10,996 \| 🐛 197 \| 🌐 Python \| 📅 2026-09-07              |
...
| fabacab/awesome-cybersecurity-blueteam | Curated Blue Team tool list                 | [github.com](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,561 \| 🐛 79 \| 📅 2024-07-15    |
| InQuest/awesome-yara                   | YARA rules collection                       | [github.com](https://github.com/InQuest/awesome-yara) ⭐ 4,270 \| 🐛 2 \| 📅 2026-06-15                       |
...
| A-poc/BlueTeam-Tools                   | 65+ Blue Team tools list                    | [github.com](https://github.com/A-poc/BlueTeam-Tools) ⭐ 4,479 \| 🐛 4 \| 📅 2026-08-23                       |
| SwiftOnSecurity/sysmon-config          | Sysmon configuration template               | [github.com](https://github.com/SwiftOnSecurity/sysmon-config) ⭐ 5,639 \| 🐛 82 \| 📅 2024-07-03             |
| redcanaryco/atomic-red-team            | Adversary emulation for detection testing   | [github.com](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,498 \| 🐛 31 \| 🌐 C \| 📅 2026-09-05      |
