...
* Install with [SwiftOnSecurity's Sysmon config](https://github.com/SwiftOnSecurity/sysmon-config) ⭐ 5,652 | 🐛 82 | 📅 2024-07-03 for a well-tuned baseline
* Alternative: [Olaf Hartong's Sysmon Modular config](https://github.com/olafhartong/sysmon-modular) ⭐ 3,134 | 🐛 49 | 🌐 Go | 📅 2026-09-18
...
| Tool                       | Purpose                                         | Link                                                                                                                                   |
| -------------------------- | ----------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| **Volatility 3**           | Memory forensics (RAM analysis)                 | [github.com/volatilityfoundation](https://github.com/volatilityfoundation/volatility3) ⭐ 4,407 \| 🐛 139 \| 🌐 Python \| 📅 2026-09-17 |
...
| **Velociraptor**           | Endpoint investigation at scale                 | [github.com/Velocidex](https://github.com/Velocidex/velociraptor) ⭐ 4,261 \| 🐛 72 \| 🌐 Go \| 📅 2026-09-18                           |
| **Eric Zimmerman's Tools** | Windows artifact parsing (MFT, ShellBags, etc.) | [ericzimmerman.github.io](https://ericzimmerman.github.io/)                                                                            |
| **Chainsaw**               | Windows event log hunting                       | [github.com/WithSecureLabs](https://github.com/WithSecureLabs/chainsaw) ⭐ 3,665 \| 🐛 4 \| 🌐 Rust \| 📅 2026-08-25                    |

### 6.5 Detection & Threat Intelligence

| Tool/Standard       | Purpose                                  | Link                                                                                                        |
| ------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| **SIGMA Rules**     | Vendor-agnostic detection rules (3,000+) | [github.com/SigmaHQ](https://github.com/SigmaHQ/sigma) ⭐ 11,064 \| 🐛 217 \| 🌐 Python \| 📅 2026-09-15     |
...
| **Shuffle**                       | Open-source SOAR                | [github.com/Shuffle](https://github.com/Shuffle/Shuffle) ⭐ 2,442 \| 🐛 492 \| 🌐 JavaScript \| 📅 2026-09-18 |
...
2. **Adversary Emulation with Atomic Red Team**
   * Install [Atomic Red Team](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,562 | 🐛 32 | 🌐 C | 📅 2026-09-14 on a test machine
...
6. **Open-Source Detection Rule Contributions**
   * Contribute to [SigmaHQ/sigma](https://github.com/SigmaHQ/sigma) ⭐ 11,064 | 🐛 217 | 🌐 Python | 📅 2026-09-15
...
| -------------------------------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| SigmaHQ/sigma                          | 3,000+ vendor-agnostic detection rules      | [github.com](https://github.com/SigmaHQ/sigma) ⭐ 11,064 \| 🐛 217 \| 🌐 Python \| 📅 2026-09-15              |
...
| fabacab/awesome-cybersecurity-blueteam | Curated Blue Team tool list                 | [github.com](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,570 \| 🐛 81 \| 📅 2024-07-15    |
...
| A-poc/BlueTeam-Tools                   | 65+ Blue Team tools list                    | [github.com](https://github.com/A-poc/BlueTeam-Tools) ⭐ 4,497 \| 🐛 4 \| 📅 2026-08-23                       |
| SwiftOnSecurity/sysmon-config          | Sysmon configuration template               | [github.com](https://github.com/SwiftOnSecurity/sysmon-config) ⭐ 5,652 \| 🐛 82 \| 📅 2024-07-03             |
| redcanaryco/atomic-red-team            | Adversary emulation for detection testing   | [github.com](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,562 \| 🐛 32 \| 🌐 C \| 📅 2026-09-14      |
